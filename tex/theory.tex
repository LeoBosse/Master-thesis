...
In 2010, two large scale structures were detected to the north and the south of the galactic center (GC) \todo{cite http://xxx.lanl.gov/abs/1005.5480}. With a diameter of 7 kpc, these two "bubbles" extend up to 40 degrees in latitude and 20 in longitude. They are a source of high energy gamma-rays and were detected by the Fermi Large Area Telescope (LAT).
...
Two main problems can be identified. A high energy deficit in the models, where the observed high energy tail (> 50 GeV) can not be reproduced \todo{cite https://arxiv.org/pdf/1602.04710.pdf}, and a spherical excess centered in the GC around 2 GeV.
