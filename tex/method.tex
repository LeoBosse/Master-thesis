...
\todo{images for proton spectrum for PCR, MCR, SCR, data}
...
\todo{images for electron spectrum for IC, BR, data}
...
\todo{images of MCR, MSP, DM on single plot.}
...
\todo{Images to illustrate isotropic calibration}
