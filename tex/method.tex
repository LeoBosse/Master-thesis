...
%\begin{figure}
% \centering
% \includegraphics[width=.9\linewidth]{pic/method/proton_shapes.png}
% \caption{images for proton spectrum for PCR, MCR, SCR, data}
% \label{fig:proton_spec}
%\end{figure}
%\begin{figure}
% \centering
% \includegraphics[width=.9\linewidth]{pic/method/el_shapes.png}
...
\begin{figure}[h]
  ...
  \begin{minipage}[h]{0.45\textwidth}
	...
	\includegraphics[width=1.\linewidth]{pic/method/proton_shapes.png}
  	\subcaption{images for proton spectrum for PCR, MCR, SCR, data}
 	\label{fig:proton_spec}
  \end{minipage}
  \hfill
  \begin{minipage}[h]{0.45\textwidth}
	  ...
	  \subcaption{images for electron spectrum for IC, BR, data}
	  \label{fig:electron_spec}
  \end{minipage}
\end{figure}
...
\begin{figure}[h]
  ...
  \begin{minipage}[h]{0.45\textwidth}
	...
	\includegraphics[trim={0 0cm 0 0.2cm}, clip, width=1.\linewidth]{pic/method/IC_variations.png}
  	\subcaption{images IC and BR variations over the sky}
...
Since every bin is fitted independantly, it is not possible to implement a spatial template, i.e. where the spatial shape of a component would be fixed in advance. For example a component with a spherical distribution around the GC, as can be done in other works \todo{cite}. The hope is to let the fit find reasonnable shapes by itself only using the $\chi ^2$ minimization technique.\\
